...
const Book = ({ book, updateBookProperty, showForm, removeBook }) => {
  return (
    <article className="flex flex-wrap items-center justify-between m-3 p-4 w-56 bg-gray-100 rounded shadow-lg">
      <p className="basis italic text-gray-500">{book.author}</p>
      <BookMenu
        book={book}
        switchReadStatus={() =>
